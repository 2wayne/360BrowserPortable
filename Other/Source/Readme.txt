...
user in an INI file next to 360BrowserPortable.exe called 360BrowserPortable.ini.
...
copy AppNamePortable.ini from this directory to 360BrowserPortable.ini next to
360BrowserPortable.exe. The options in the INI file are as follows:
